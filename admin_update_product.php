...
if(isset($_POST['update_product'])){
   ...
   if(!empty($image)){
      if($image_size > 2000000){
         ...
         $message[] = 'Slika je ažurirana uspješno!';
      }
   }

   $message[] = 'Proizvod je ažuriran uspješno!';
...
<form action="" method="post" enctype="multipart/form-data">
   ...
   <input type="submit" value="ažuriraj proizvod" name="update_product" class="btn">
   <a href="admin_products.php" class="option-btn">nazad</a>
</form>

<?php
      }
   }else{
      echo '<p class="empty">NIJE ODABRANA PROMJENA PROIZVODA</p>';
   }
?>
</section>
